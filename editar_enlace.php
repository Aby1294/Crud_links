...
<?php
    ...
    if (isset($_POST["editarEnlace"])) {
        ...
        if (empty($enlace) || empty($categoria)) {
            ...
            $query = "UPDATE ENLACE SET ENLACE=:enlace, DESCRIPCION=:descripcion, CATEGORIA_ID=:categoria_id WHERE ID=:id";
            ...
            if ($resultado) {
                $mensaje = "Enlace editado correctamente";
    ...
    <div class="row">
        ...
        <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nombre_enlace" placeholder="Ingresa el enlace" value="<?php echo $enlace->ENLACE; ?>">                
            </div>

            <div class="mb-3">
                <label for="descripcion" class="form-label">Descripción:</label>
                <input type="text" class="form-control" name="descripcion" placeholder="Ingresa la descripción" value="<?php echo $enlace->DESCRIPCION; ?>">                
            </div> 
